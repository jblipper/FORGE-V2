...
python3 run.py 'humfooddecay0.2' '0.1,0.3,50,54.6,39.3,1/25,1/80,0.2' & # control; no parameters changed from default
python3 run.py 'humfooddecay0.1' '0.1,0.3,50,54.6,39.3,1/25,1/80,0.1' & # control; no parameters changed from default
python3 run.py 'humfooddecay0.05' '0.1,0.3,50,54.6,39.3,1/25,1/80,0.05' & # control; no parameters changed from default
python3 run.py 'humfooddecay0.01' '0.1,0.3,50,54.6,39.3,1/25,1/80,0.01' & # control; no parameters changed from default
python3 run.py 'humfooddecay0.14' '0.1,0.3,50,54.6,39.3,1/25,1/80,0.2,0.14' & # control; no parameters changed from default
