...
# This module predicts the time evolution of human. The full methods section and equations referenced in the comments on this module are outlined in Global hunter-gatherer population densities constrained by influence of seasonality on diet composition
