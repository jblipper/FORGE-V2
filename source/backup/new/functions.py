...
# This module changes the time resolution of the output data of the forge model to be saved to the output netCDF file. The daily resolved data is either kept as daily resolution, decreased to monthly resolution, or decreased to yearly resolution.
